...
<?endif?>
		<input type="submit" class="btn btn-oblong btn-dark" name="Login" value="<?=GetMessage("AUTH_LOGIN_BUTTON")?>" />
    ...
    <nav class="nav">
        <div class="dropdown">
            <div class="nav-link-profile">
                ...
                <span class="logged-name hidden-md-down"><?=$arResult["USER_NAME"]?></span>
                <input type="hidden" name="logout" value="yes" />
                <input type="submit" class="btn btn-oblong btn-dark" name="logout_butt" value="<?=GetMessage("AUTH_LOGOUT_BUTTON")?>" />
                </form>
            </div>
        </div>
    </nav>
